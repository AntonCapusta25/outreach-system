...
const APPS_SCRIPT_CONFIG = {
  WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbwlT_lhEUcDxZMQCZgSNp-av9GUKyr-pc0lDXBKPLFVz323m6ZQ7cp1kWrTOzDaBekF/exec', // Replace with your deployed Apps Script URL

...
const APPS_SCRIPT_CONFIG = {
  WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbzLZpuLlgVx3ZgHExmTpUrSU7pqCsMn7vSh9b818-c7DNgW75OIyKAmiyKLnIOxMhmrOg/exec', // Replace with your deployed Apps Script URL

...
const APPS_SCRIPT_CONFIG = {
  WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbx_xtnGoicKH2Z1WRfii7IRqR08oPz_CYtOVhkWwJABKmW4oQvSwQhJKqbHzqNlzNRS/exec', // Replace with your deployed Apps Script URL

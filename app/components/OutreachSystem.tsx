...
const APPS_SCRIPT_CONFIG = {
  WEB_APP_URL: 'https://script.google.com/macros/s/AKfycbzJGUBiHTx8-MeuRCiN1WRvfnuEhHB2F7h2Jfgs1_TnsaXQeabhmxyubNyBISDSx3Wn/exec', // Replace with your deployed Apps Script URL
